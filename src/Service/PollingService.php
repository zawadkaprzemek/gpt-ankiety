...
class PollingService
{
    ...
    public function getAllPollings(): array
    {
        $repo = $this->em->getRepository(Polling::class);
        return $repo->findAll();
    }

    public function updateQuestionsSort(Question $question):void
    {
        /** @var $repo QuestionRepository */
        $repo = $this->em->getRepository(Question::class);
    ...
    public function updatePagesNumber(Page $page):void
    {
        /** @var $repo PageRepository */
        $repo = $this->em->getRepository(Page::class);
    ...
    public function checkLogic($votes, $questions): array
    {
        $rules = [];
    ...
    private function compareAnswerWithLogic(Logic $logic, $answers): bool
    {
    ...
    public function duplicatePolling(Polling $polling): Polling
    {
    ...
    public function hardDeleteQuestionsFromPage(Page $page):void
    {
        foreach ($page->getQuestions() as $question)
        {
            ...
            $this->updateQuestionsSort($question);
